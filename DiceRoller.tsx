    ...
    <div className="fixed bottom-20 right-4 w-80 bg-white rounded-lg shadow-2xl border-2 border-victory-orange overflow-hidden z-50 flex flex-col font-body animate-in slide-in-from-bottom-5 fade-in duration-300">
      ...
      <div className="p-4 bg-white border-b border-gray-200">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <LocalNumericInput label="Bônus" value={bonus} onChange={setBonus} />
          <LocalNumericInput label="Dados" value={diceCount} onChange={setDiceCount} min={1} />
          <LocalNumericInput label="Crítico" value={critRange} onChange={setCritRange} min={1} max={6} className="text-red-600" />
        </div>
        ...
        {history.map((roll) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mt-1">
              ...
              {/* Total: número sempre visível; em falha crítica aparece tachado com o texto abaixo */}
              <div className="pl-2 text-right">
                {roll.isCritFail ? (
                  <>
                    <div className="text-2xl font-header font-bold text-red-400 line-through leading-none">
                      {roll.total}
                    </div>
                    <div className="text-[10px] font-bold text-red-600 uppercase leading-tight">
                      Falha Crítica
                    </div>
                  </>
                ) : (
